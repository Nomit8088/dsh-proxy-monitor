...
export const en = {
  ...
  modelCatalogIntro:
    "Refresh pulls the live Codex account catalog (including gpt-6-luna / gpt-6-sol). Enable image support so DSH sends attachments natively instead of intercepting them.",
...
export const zh: { [Key in OpenAICodexSettingsKey]: string } = {
  ...
  modelCatalogIntro:
    "刷新会从 Codex 账号活体目录拉取（含 gpt-6-luna / gpt-6-sol）。勾选「支持图像」后 DSH 不会把图片拦截成文本。",
