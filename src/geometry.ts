 ...
 */
export function computeInsets(input: InsetsInput): FrameInsets {
 ...
 */
export function computeTurnNavShift(input: TurnNavInput): number {
 ...
 */
export function sameInsets(left: FrameInsets, right: FrameInsets): boolean {
  return (
...
export const NO_INSETS: FrameInsets = { sidebar: 0, rightbar: 0, rightbarFullscreen: false }
