 ...
 */
import { FileCredentialStore, FileModelSettingsStore, AntigravityAdapter, PROVIDER, credentialPath, modelSettingsPath, apply as applyAntigravity, } from './antigravity/index.js';
import { installOrTakeOverAdapter } from './llm-takeover.js';
export function setupAntigravity(ctx) {
    ...
    ctx.inject(['llm'], (llmCtx) => {
        ...
        installOrTakeOverAdapter(llmCtx.llm, PROVIDER, adapter, ctx.logger);
    });
...
//# sourceMappingURL=antigravity-integration.js.map