...
import { diagnoseOpenAICodex, loginOpenAICodex, logoutOpenAICodex, openAICodexAuthPath, openAICodexAuthStatus, } from './index.js';
import { CODEX_CONNECT_VERSION } from './doctor.js';
import { normalizeTrustedOrigin, OpenAICodexTrustedOriginsStore } from './trusted-origins.js';
...
export async function run(argv) {
    ...
    const actions = ['doctor', 'login', 'logout', 'status', 'trust-origin', 'trusted-origins', 'untrust-origin'];
