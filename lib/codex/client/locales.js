...
export const en = {
    ...
    proxyModeScopedHint: "Only Codex HTTP requests after authentication use this proxy. OAuth token refresh and WebSocket transport continue to follow dsh networking.",
