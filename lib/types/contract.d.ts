 ...
 */
export declare const PROXY_MONITOR_ROUTE = "/api/proxy-monitor";
/**
 ...
 */
export declare const PROXY_MONITOR_ENDPOINTS: readonly ["snapshot", "refresh", "accounts", "login", "loginPoll", "logout"];
