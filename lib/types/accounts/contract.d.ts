...
export type LoginMethod = NoLoginMethod | BrowserLoginMethod | DeviceLoginMethod | DeviceRequestLoginMethod | CliLoginMethod;
/**
 ...
 */
export declare function canLogin(adapter: AccountAdapter): adapter is AccountAdapter & Required<Pick<AccountAdapter, 'beginLogin' | 'pollLogin'>>;
/**
 * Whether an adapter can end the current session.
 * @param adapter - the adapter to inspect.
 * @returns true when a logout is available.
 */
export declare function canLogout(adapter: AccountAdapter): adapter is AccountAdapter & Required<Pick<AccountAdapter, 'logout'>>;
