...
export declare const OPENAI_CODEX_CONTEXT_SOURCE = "openai-codex-context";
/** Plugin name recorded on every injected message. */
export declare const OPENAI_CODEX_PLUGIN_NAME = "dsh-openai-codex";
 ...
 */
export declare function openAICodexContextSource(): {
    kind: 'user';
    plugin: string;
};
